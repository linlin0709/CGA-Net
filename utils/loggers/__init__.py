...
class Loggers():
    ...
    def __init__(self, save_dir=None, weights=None, opt=None, hyp=None, logger=None, include=LOGGERS):
        ...
        self.best_keys = ['best/epoch', 'best/precision', 'best/recall', 'best/mAP_0.5',
                          'best/mAP_0.55','best/mAP_0.6','best/mAP_0.65', 'best/mAP_0.7','best/mAP_0.75','best/mAP_0.8','best/mAP_0.85','best/mAP_0.9','best/mAP_0.95',
                          'best/mAP_0.5:0.95']
    ...
    def on_train_batch_end(self, ni, model, imgs,imgs2, targets, paths,paths2, plots):
        ...
        if plots:
            ...
            if ni < 3:
                ...
                plot_images(imgs2, targets, paths2, f2)
