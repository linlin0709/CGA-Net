...
from utils.metrics import bbox_iou, bbox_iou_Focal
...
class ComputeLoss:
    ...
    def __call__(self, p, targets):  # predictions, targets   P: list,3个元素对应3个head，分别为ba，na，ny, nx,no
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                pxy, pwh, _, pcls = pi[b, a, gj, gi].split((2, 2, 1, self.nc), 1)  # target-subset of predictions  xywh,conf,cls
